...
const CvTemplate1 = (props: CVTemplateProps) => {
      ...
      return (
        ...
        >
          ...
          <Col className="py-4 mx-4">
            {workingExperiences.map((uWE, id: number) => {
              return (
                <div>
  ...
  const renderEducation = (educations: EducationDto[] | undefined) => {
    if (educations && educations.length) {
      return (
        ...
        >
          ...
          <Col className="py-4 mx-4">
            {educations.map((education, id: number) => {
              return (
                <div>
                  <h3
                    className="text-dark font-weight-bold"
